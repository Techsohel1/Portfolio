...
const Navbar = () => {
  ...
  return (
    <>
    <div className='max-w-screen-2xl container mx-auto px-4 md:px-20 h- shadow-md fixed top-0 left-0 right-0 z-50 bg-white'>
    <div className='flex justify-between items-center h-16'>
        <div className='flex space-x-2'>
            <img src={pic} className='h-12 w-12 rounded-full' alt="" />
            <h1 className='font-bold text-xl cursor-pointer'>Sohel Khan 
                <p className='font-semibold text-gray-700 text-sm'>Web Developer</p>
            </h1>
        </div>
        {/* Desktop navbar */}
        <div>
